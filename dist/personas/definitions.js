...
exports.LAYER_DEFINITIONS = exports.PERSONA_DEFINITIONS = void 0;
exports.getPersona = getPersona;
exports.getPersonasByTrigger = getPersonasByTrigger;
...
function getPersona(name) {
    return exports.PERSONA_DEFINITIONS[name.toLowerCase()];
}
function getPersonasByTrigger(trigger) {
    const lowerTrigger = trigger.toLowerCase();
    return Object.values(exports.PERSONA_DEFINITIONS)
